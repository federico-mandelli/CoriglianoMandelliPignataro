...
\begin{enumerate}[label=\textbf{R\arabic*}]
    ...
    \todo[inline]{Come fa la charging socket/station ad inviare una mail allo user? se non si interagisce indietro con il CPMS anche questo requirement non è soddisfatto da nessun componente}
    % \ref{AuthenticationComponent}
    % \ref{eMallModel}
    % \ref{ChargeManagerComponent}
    % \ref{MailAPI}
