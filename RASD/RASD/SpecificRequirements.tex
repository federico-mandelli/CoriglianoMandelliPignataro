...
\subsubsection{Use cases}
    ...
    \begin{table}[h]
        \begin{center}
            \begin{tabular}{|c||p{10cm}|}
                ...
                \\
                \hline
                Exit condition: & The user now have an active account \\
                \hline
                Exceptions: &
                \begin{itemize}
                    ...
                    \item The user inserts an email already registered to the system: the system notifies the user without letting the process continue;
        ...
        \begin{center}
            \begin{tabular}{|c||p{10cm}|}
                ...
                \begin{itemize}
                    ...
                    \item The \ac{CPO} inserts an email already registered to the system: the system notifies the \ac{CPO} without letting the process continue;
    ...
    \begin{table}[h]
        \begin{center}
            \begin{tabular}{|c||p{10cm}|}
                ...
                \hline
                Entry conditions: & The actor is not yet logged in\\
                \hline
                Event flow: & 
                \begin{enumerate}
                    ...
                    \item The system let the actor access their available features;
                \end{enumerate}
                \\
                \hline
                Exit condition: & The actor is logged in into the system and can perform their specific actions (i.e. for the user: searching near stations, booking a charge, deleting a charge, paying for a charge and view previously booked charges; for the \ac{CPO}: adding a \ac{CPMS}, removing a \ac{CPMS}, setting revenue percentage, setting special offers) \\
                \hline
                Exceptions: &
                \begin{itemize}
    ...
    \begin{table}[h]
        \begin{center}
            \begin{tabular}{|c||p{10cm}|}
                ...
                \\
                \hline
                Exit condition: & A \ac{CPMS} is added to the system and can be reached for booking of charges or queries by users. \\
                \hline
                Exceptions: &
                \begin{itemize}
    ...
    \todo[inline]{Other use cases to do:\\
    - CPO sets a special offer\\
    - user gets the nearby charging stations\\
    - user books a charge\\
    - user pays for a charge\\
    - user performs a charge\\
    - user cancels a charge\\
    - system suggests charge via calendar\\
    - CPOmaintainer logs into CPMS\\
    - CPOmaintainer adds stations to CPMS\\
    - CPOmaintainer manages CPMS\\
    }
...
\begin{figure}[!h]
    ...
    \todo[inline]{Adding set special offers in "Registered \ac{CPO}" use case diagram}
...
\begin{figure}[!h]
    \begin{center}
        ...
        \todo[inline]{Splitting "Registration of \ac{CPO}" and "setting revenue percentage" sequence diagrams}
    \end{center}
\end{figure}
\begin{figure}[!h]
    \begin{center}
