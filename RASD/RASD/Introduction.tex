...
\begin{enumerate}[label=\textbf{G\arabic*}]
    ...
    \item \acp{CPMS} shall handle the vehicle charging cycles;\label{goal:CPMS-handles-charge}
          \todo[inline]{CPMS o charging stations}
...
\begin{multicols}{2}[]
    \begin{acronym}[RASD]
        \acro{RASD}{Requirements Analysis and Specification Document}
...
\todo[inline]{Add revision history?}

\subsection{Reference Documents}
\todo[inline]{Add reference documents?}
\newpage
