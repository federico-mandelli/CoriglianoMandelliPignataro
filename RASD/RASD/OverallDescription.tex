...
\begin{enumerate}[label=\textbf{S\arabic*}]
      ...
      \item \ac{CPO} subscribes to the system:\\
            ...
            She opens the \ac{eMall} service and selects to sign up as \ac{CPO}, she inserts the name, email, \gls{partita IVA}, \ac{IBAN}, a master password and connects the \acp{CPMS} to the site via an \ac{API} reference;\label{SCE:cpo-signs-up}
      \item \ac{CPO} adds \ac{CPMS} to the system:
            Bob, after logging in the system, wants to add \ac{CPMS} to the system. Once logged in the systems he adds the \ac{API} references to the various \ac{CPMS}.it to \ac{eMall} to improve sales.label{SCE:cpo-adds-cpms}
