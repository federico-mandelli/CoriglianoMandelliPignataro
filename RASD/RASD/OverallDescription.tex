...
\begin{enumerate}[label=\textbf{S\arabic*}]
      ...
      \item \ac{CPO} subscribes to the system:\\
            ...
            She opens the eMall website and selects to sign up as \ac{CPO}, she inserts the name, email, \gls{partita IVA}, \ac{IBAN}, a master password and connects/disconnects the \acp{CPMS} to the site via an \ac{API} reference;\label{SCE:cpo-signs-up}
