...
\begin{enumerate}[label=\textbf{S\arabic*}]
      ...
      \item \ac{CPO} adds/removes \ac{CPMS} to the system:\\
            Bob, after logging in the system, wants to add/remove the \ac{CPMS} to the system. Once logged in the system he adds the \ac{API} references to the \acp{CPMS}, or inserts the \ac{API} reference to remove.
      ...
      \item \ac{CPO}maintainer adds stations to the \ac{CPMS}:\\
            Frank, the responsible for a \ac{CPMS}, wants to add stations to the \ac{CPMS}. For each station he has to insert the \ac{API} reference;\label{SCE:cpomaintainer-adds-stations}
...
\begin{enumerate}[label=\textbf{DA\arabic*}]
      ...
      \item All the users have an active internet and \ac{GPS} connection always available while using the service;
