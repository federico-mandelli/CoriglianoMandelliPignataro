...
\todo[inline]{Secondo me questi dovrebbero rispecchiare i metodi delle interfacce che si vedono nell'UML. Meglio se sono atomici o aggregati? es: staccare registrazione e login o avere un paragrafo solo per l'identificazione?}
...
\todo[inline]{Get only informations through the app about the starting of the charging process? Or actively do it on the app? I think this is up to the charging station with his framework. CS maybe communicates to the CSPM that his socket is active (charging something). Then the eMSP polls the state and can say that "the socket you booked is now active"} 
